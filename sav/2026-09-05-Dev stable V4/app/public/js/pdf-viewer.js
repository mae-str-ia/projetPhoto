...
const PdfViewer = {
    ...
    async _getDoc() {
        ...
        const version = typeof BOOK_CONFIG !== 'undefined' ? BOOK_CONFIG.pdfVersion : Date.now();
        this._pdf = await pdfjsLib.getDocument(BASE_URL + '/api/texte-pdf.php?v=' + encodeURIComponent(version)).promise;
        return this._pdf;
    }
};
