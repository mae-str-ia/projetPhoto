...
$totalSpreads = intdiv(($book['totalPages'] ?? TOTAL_PAGES) - 1, 2);
    ...
    <div class="spread-pages">
        ...
        <div class="spread-page photo" id="photoPage" data-page-number="<?php echo $leftPage['pageNumber']; ?>">
            <div class="page-header">
                ...
                <h3>Planche <?php echo $spreadNumber; ?> <small style="color:#999;font-weight:normal">(p.<?php echo $leftPage['pageNumber'] + $offset; ?>)</small></h3>
            </div>
