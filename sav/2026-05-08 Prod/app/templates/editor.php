...
// Right page number = left page number - 1 (text page, always odd)
$rightPageNumber = $pageNumber - 1;
// Spread number for return-to-gallery
...
<div class="editor-container">
    <div class="editor-toolbar">
        ...
        <div class="toolbar-group toolbar-nav-group">
            <?php if ($pageNumber - 2 >= 2): ?>
                <a href="?page=editor&num=<?php echo $pageNumber - 2; ?>" class="toolbar-button toolbar-icon-button" id="prevSpread" title="Planche précédente" aria-label="Planche précédente">‹</a>
            <?php endif; ?>
            <span class="page-ref-label">Page <?php echo $rightPageNumber; ?></span>
            <?php if ($pageNumber + 2 <= $totalPages): ?>
                <a href="?page=editor&num=<?php echo $pageNumber + 2; ?>" class="toolbar-button toolbar-icon-button" id="nextSpread" title="Planche suivante" aria-label="Planche suivante">›</a>
            <?php endif; ?>
