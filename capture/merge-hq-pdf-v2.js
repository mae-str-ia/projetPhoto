...
const PAGE_MAP_FILE = path.join(__dirname, '../data/markdown/build/page-map.json');
const TEXT_PDF_FILE = path.join(__dirname, '../data/outputs/texte.pdf');
const SCREENSHOTS_DIR = path.join(__dirname, '../data/cache/screenshots');
const OUTPUT_PDF = path.join(__dirname, '../livre.print.pdf');
